    ...
    return [
      {
        ...
        headers: [
          ...
          {
            // Content Security Policy — adattare se si usano CDN esterni
            ...
            value: [
              ...
              "font-src 'self'",
              "connect-src 'self' https://api.stripe.com https://checkout.stripe.com https://nominatim.openstreetmap.org",
