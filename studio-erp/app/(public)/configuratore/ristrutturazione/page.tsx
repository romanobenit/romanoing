...
export default function ConfiguratoreRistrutturazione() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 to-white">
      ...
      {/* Hero */}
      <div className="bg-gradient-to-r from-orange-600 to-amber-600 text-white py-8 print:py-4">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold mb-3 print:text-3xl">Configuratore Ristrutturazione</h1>
          <p className="text-xl text-orange-50 print:text-base">
            Scopri subito quanto costa il tuo progetto
          </p>
          <p className="text-sm text-orange-100 mt-2 print:hidden">
                ...
                <CardContent className="p-6">
                  {preventivo && preventivo.totale > 0 ? (
                    <>
                      ...
                      {/* Actions */}
                      <div className="space-y-2 print:hidden mt-6">
                        <Button onClick={sendEmail} className="w-full bg-orange-600 hover:bg-orange-700" size="lg" disabled={emailSending}>
